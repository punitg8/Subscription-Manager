...
public final class AuthenticationServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.subscriptionmanager.AuthenticationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.subscription.proto.CreateUserRequest,
      com.subscription.proto.User> getCreateUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createUser",
      requestType = com.subscription.proto.CreateUserRequest.class,
      responseType = com.subscription.proto.User.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.subscription.proto.CreateUserRequest,
      com.subscription.proto.User> getCreateUserMethod() {
    io.grpc.MethodDescriptor<com.subscription.proto.CreateUserRequest, com.subscription.proto.User> getCreateUserMethod;
      ...
      synchronized (AuthenticationServiceGrpc.class) {
        if ((getCreateUserMethod = AuthenticationServiceGrpc.getCreateUserMethod) == null) {
          AuthenticationServiceGrpc.getCreateUserMethod = getCreateUserMethod =
              io.grpc.MethodDescriptor.<com.subscription.proto.CreateUserRequest, com.subscription.proto.User>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.subscription.proto.CreateUserRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.subscription.proto.User.getDefaultInstance()))
  ...
  public static abstract class AuthenticationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createUser(com.subscription.proto.CreateUserRequest request,
        io.grpc.stub.StreamObserver<com.subscription.proto.User> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.subscription.proto.CreateUserRequest,
                com.subscription.proto.User>(
  ...
  public static final class AuthenticationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AuthenticationServiceBlockingStub> {
    ...
    /**
     */
    public com.subscription.proto.User createUser(com.subscription.proto.CreateUserRequest request) {
  ...
  public static final class AuthenticationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AuthenticationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.subscription.proto.User> createUser(
        com.subscription.proto.CreateUserRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_USER:
          serviceImpl.createUser((com.subscription.proto.CreateUserRequest) request,
              (io.grpc.stub.StreamObserver<com.subscription.proto.User>) responseObserver);
          break;
        default:
