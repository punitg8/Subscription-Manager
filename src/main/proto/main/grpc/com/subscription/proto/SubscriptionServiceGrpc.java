...
public final class SubscriptionServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.subscription.proto.CreateSubscriptionRequest,
      com.subscription.proto.Subscription> getCreateSubscriptionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createSubscription",
      requestType = com.subscription.proto.CreateSubscriptionRequest.class,
      responseType = com.subscription.proto.Subscription.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.subscription.proto.CreateSubscriptionRequest,
      com.subscription.proto.Subscription> getCreateSubscriptionMethod() {
    io.grpc.MethodDescriptor<com.subscription.proto.CreateSubscriptionRequest, com.subscription.proto.Subscription> getCreateSubscriptionMethod;
      ...
      synchronized (SubscriptionServiceGrpc.class) {
        if ((getCreateSubscriptionMethod = SubscriptionServiceGrpc.getCreateSubscriptionMethod) == null) {
          SubscriptionServiceGrpc.getCreateSubscriptionMethod = getCreateSubscriptionMethod =
              io.grpc.MethodDescriptor.<com.subscription.proto.CreateSubscriptionRequest, com.subscription.proto.Subscription>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createSubscription"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.subscription.proto.CreateSubscriptionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.subscription.proto.Subscription.getDefaultInstance()))
  ...
  public static abstract class SubscriptionServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createSubscription(com.subscription.proto.CreateSubscriptionRequest request,
        io.grpc.stub.StreamObserver<com.subscription.proto.Subscription> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.subscription.proto.CreateSubscriptionRequest,
                com.subscription.proto.Subscription>(
  ...
  public static final class SubscriptionServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SubscriptionServiceBlockingStub> {
    ...
    /**
     */
    public com.subscription.proto.Subscription createSubscription(com.subscription.proto.CreateSubscriptionRequest request) {
  ...
  public static final class SubscriptionServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SubscriptionServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.subscription.proto.Subscription> createSubscription(
        com.subscription.proto.CreateSubscriptionRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_SUBSCRIPTION:
          serviceImpl.createSubscription((com.subscription.proto.CreateSubscriptionRequest) request,
              (io.grpc.stub.StreamObserver<com.subscription.proto.Subscription>) responseObserver);
          break;
        default:
