...
public final class NewsServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.subscriptionmanager.NewsService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.subscription.proto.CreateNewsRequest,
      com.subscription.proto.News> getCreateNewsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createNews",
      requestType = com.subscription.proto.CreateNewsRequest.class,
      responseType = com.subscription.proto.News.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.subscription.proto.CreateNewsRequest,
      com.subscription.proto.News> getCreateNewsMethod() {
    io.grpc.MethodDescriptor<com.subscription.proto.CreateNewsRequest, com.subscription.proto.News> getCreateNewsMethod;
      ...
      synchronized (NewsServiceGrpc.class) {
        if ((getCreateNewsMethod = NewsServiceGrpc.getCreateNewsMethod) == null) {
          NewsServiceGrpc.getCreateNewsMethod = getCreateNewsMethod =
              io.grpc.MethodDescriptor.<com.subscription.proto.CreateNewsRequest, com.subscription.proto.News>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createNews"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.subscription.proto.CreateNewsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.subscription.proto.News.getDefaultInstance()))
  ...
  public static abstract class NewsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createNews(com.subscription.proto.CreateNewsRequest request,
        io.grpc.stub.StreamObserver<com.subscription.proto.News> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.subscription.proto.CreateNewsRequest,
                com.subscription.proto.News>(
  ...
  public static final class NewsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<NewsServiceBlockingStub> {
    ...
    /**
     */
    public com.subscription.proto.News createNews(com.subscription.proto.CreateNewsRequest request) {
  ...
  public static final class NewsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<NewsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.subscription.proto.News> createNews(
        com.subscription.proto.CreateNewsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_NEWS:
          serviceImpl.createNews((com.subscription.proto.CreateNewsRequest) request,
              (io.grpc.stub.StreamObserver<com.subscription.proto.News>) responseObserver);
          break;
        default:
