...
public final class GenreServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.subscriptionmanager.GenreService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.subscription.proto.CreateGenreRequest,
      com.subscription.proto.Genre> getCreateGenreMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createGenre",
      requestType = com.subscription.proto.CreateGenreRequest.class,
      responseType = com.subscription.proto.Genre.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.subscription.proto.CreateGenreRequest,
      com.subscription.proto.Genre> getCreateGenreMethod() {
    io.grpc.MethodDescriptor<com.subscription.proto.CreateGenreRequest, com.subscription.proto.Genre> getCreateGenreMethod;
      ...
      synchronized (GenreServiceGrpc.class) {
        if ((getCreateGenreMethod = GenreServiceGrpc.getCreateGenreMethod) == null) {
          GenreServiceGrpc.getCreateGenreMethod = getCreateGenreMethod =
              io.grpc.MethodDescriptor.<com.subscription.proto.CreateGenreRequest, com.subscription.proto.Genre>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createGenre"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.subscription.proto.CreateGenreRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.subscription.proto.Genre.getDefaultInstance()))
  ...
  public static abstract class GenreServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createGenre(com.subscription.proto.CreateGenreRequest request,
        io.grpc.stub.StreamObserver<com.subscription.proto.Genre> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.subscription.proto.CreateGenreRequest,
                com.subscription.proto.Genre>(
  ...
  public static final class GenreServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GenreServiceBlockingStub> {
    ...
    /**
     */
    public com.subscription.proto.Genre createGenre(com.subscription.proto.CreateGenreRequest request) {
  ...
  public static final class GenreServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GenreServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.subscription.proto.Genre> createGenre(
        com.subscription.proto.CreateGenreRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_GENRE:
          serviceImpl.createGenre((com.subscription.proto.CreateGenreRequest) request,
              (io.grpc.stub.StreamObserver<com.subscription.proto.Genre>) responseObserver);
          break;
        default:
