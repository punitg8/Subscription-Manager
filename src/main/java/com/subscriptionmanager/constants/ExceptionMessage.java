package com.subscriptionmanager.constants;

public class ExceptionMessage {

  public static final String NON_NUMERIC_PAGE_TOKEN_EXCEPTION = "Page token is not a number";
  ...
  public static final String RESOURCE_NAME_PARSING_EXCEPTION = "Exception while parsing resource name";
